...
<head>
    ...
    <link href="<c:url value="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"/>"
          rel="stylesheet">
    ...
    <link href="<c:url value="/template/web/css/dash-manage-order.css"/>" rel="stylesheet">
    <link href="<c:url value="/template/web/css/dash-my-order.css"/>" rel="stylesheet">
