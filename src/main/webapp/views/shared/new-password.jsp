...
<html>
<head>
    <title><dec:title default="Nai -  New Password"/></title>
</head>
<body>
        ...
        <div class="card-body">
            <form class="form" role="form" autocomplete="off" method="post" action="/new-password">
                ...
                <div class="form-group">
                    <label for="inputPasswordNew">Your New Password</label>
...
<%--                                        </span>--%>
                ...
                <div class="form-group">
                    <label for="reInputPassword">Retype Your New Password</label>
