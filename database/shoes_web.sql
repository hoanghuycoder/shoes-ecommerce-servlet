...
(8, '111635119529567317993', '21130386@st.hcmuaf.edu.vn', NULL, 'Trần Võ Hoàng Huy', NULL, 'admin', 'google', '2024-04-04 03:25:19', '2023-12-28 04:21:13', '2024-04-04 03:25:35', 0),
...
ALTER TABLE `roles`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `roles_pk_2` (`code`);
