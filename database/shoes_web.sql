...
-- Dumping data for table shoes_web.logs: ~23 rows (approximately)
...
INSERT INTO `logs` (`id`, `ip`, `location`, `level`, `action`, `resource`, `preValue`, `value`, `createAt`, `updateAt`, `isDeleted`) VALUES
	...
	(549, '127.0.0.1', 'null , <br/>null', 'INFO', 'SELECT', 'com.ltweb_servlet_ecommerce.controller.web.shared.HomeController:43', NULL, '{"status":"Access the path http://localhost:8080/home"}', '2024-04-19 14:33:40', '2024-04-19 14:34:56', 1),
	(550, '127.0.0.1', 'null , <br/>null', 'INFO', 'SELECT', 'com.ltweb_servlet_ecommerce.controller.web.shared.HomeController:43', NULL, '{"status":"Access the path http://localhost:8080/home"}', '2024-04-19 14:33:42', '2024-04-19 14:34:56', 1),
	(551, '0:0:0:0:0:0:0:1', 'null , <br/>null', 'INFO', 'SELECT', 'com.ltweb_servlet_ecommerce.controller.web.shared.HomeController:43', NULL, '{"status":"Access the path http://localhost:8080/home"}', '2024-04-19 14:33:42', '2024-04-19 14:34:56', 1),
	(552, '0:0:0:0:0:0:0:1', 'null , <br/>null', 'WARN', 'UPDATE', 'com.ltweb_servlet_ecommerce.service.impl.UserService:94', '{"value":{"lastLogged":"2024-04-18 23:26:26.0"}}', '{"value":{"lastLogged":"2024-04-19 14:34:15.0"},"status":"UpdatedAt and lastLogged fields successfully updated"}', '2024-04-19 14:34:15', '2024-04-19 14:34:56', 1),
	(553, '0:0:0:0:0:0:0:1', 'null , <br/>null', 'INFO', 'SELECT', 'com.ltweb_servlet_ecommerce.controller.web.shared.LoginController:67', NULL, '{"value":{"id":14,"email":"vophihoang252003@gmail.com"},"status":"Authentication successful"}', '2024-04-19 14:34:15', '2024-04-19 14:34:56', 1);
...
INSERT INTO `users` (`id`, `userName`, `email`, `password`, `fullName`, `birthDay`, `association`, `lastLogged`, `roleId`, `createAt`, `updateAt`, `isDeleted`) VALUES
	...
	(14, 'a', 'vophihoang252003@gmail.com', '$2a$12$9szEjqLykjaQVvPTnccyRuPLqAfBwCUMRNut8OECjLXLS4HW0LyiG', 'Vo Hoang', NULL, 'none', '2024-04-19 14:34:15', 1, '2024-03-13 15:14:47', '2024-04-19 14:34:15', 0),
