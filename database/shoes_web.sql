...
-- Dumping data for table shoes_web.addresses: ~10 rows (approximately)
...
-- Dumping data for table shoes_web.carts: ~3 rows (approximately)
...
INSERT INTO `carts` (`id`, `userId`, `orderDetailsId`, `createAt`, `updateAt`, `isDeleted`) VALUES
	...
	(22, 14, 46, '2024-06-16 16:32:16', '2024-06-16 16:32:16', 0);
...
-- Dumping data for table shoes_web.orders: ~5 rows (approximately)
/*!40000 ALTER TABLE `orders` DISABLE KEYS */;
INSERT INTO `orders` (`id`, `status`, `note`, `totalAmount`, `addressId`, `isPaid`, `slug`, `createAt`, `updateAt`, `isDeleted`) VALUES
	(11, 'ORDER_TRANSPORTING', 'Gọi trước khi giao', 1050000.0, 10, 0, 'KyPl35OTpN', '2024-04-05 00:18:28', '2024-06-16 16:45:20', 0),
...
-- Dumping data for table shoes_web.order_details: ~13 rows (approximately)
...
INSERT INTO `order_details` (`id`, `quantity`, `subTotal`, `orderId`, `productSizeId`, `createAt`, `updateAt`, `isDeleted`) VALUES
	...
	(46, 1, 1609000.0, NULL, 88, '2024-06-16 16:32:16', '2024-06-16 16:42:55', 0),
...
-- Dumping data for table shoes_web.product_sizes: ~129 rows (approximately)
...
INSERT INTO `users` (`id`, `userName`, `email`, `password`, `fullName`, `birthDay`, `association`, `lastLogged`, `roleId`, `createAt`, `updateAt`, `isDeleted`) VALUES
	(6, 'hoanghuydev', 'tranvohoanghuy12ab@gmail.com', '$2a$12$n1ZRw5rmlRGU0uqK6USVR.p8i66degNqeanwUZK9j0hdgDF8gfvVm', 'Tran Vo Hoang Huy', NULL, 'none', '2024-05-26 21:48:53', 1, '2023-12-27 08:23:38', '2024-05-26 21:48:53', 0),
	...
	(14, 'a', 'vophihoang252003@gmail.com', '$2a$12$9szEjqLykjaQVvPTnccyRuPLqAfBwCUMRNut8OECjLXLS4HW0LyiG', 'Vo Hoang', '2024-08-01', 'none', '2024-06-16 16:11:53', 1, '2024-03-13 08:14:47', '2024-06-16 16:11:53', 0),
...
-- Dumping data for table shoes_web.user_orders: ~2 rows (approximately)
...
-- Dumping data for table shoes_web.vouchers: ~3 rows (approximately)
...
-- Dumping data for table shoes_web.voucher_conditions: ~2 rows (approximately)
